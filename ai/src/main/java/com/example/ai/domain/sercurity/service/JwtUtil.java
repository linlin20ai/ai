...
/**
 * @author 林圣涛
 * 获取JwtToken，获取JwtToken中的封装信息，判断JwtToken是否存在
 * 1.encode(),参数是=签发人，存在时间，一些其他的信息，返回值是JwtToken是否存在
    ...
    * */
    public String encode(String issuer, long ttlMillis, Map<String, Object> claims) {
        ...
        JwtBuilder builder = Jwts.builder()
                //荷载部分
                .setClaims(claims)
                //这个是JWT的唯一识别，一般设置为唯一的，这个方法可以生成唯一标识
